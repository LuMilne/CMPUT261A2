"""
lemilne@ualberta.ca
ve.py originally sourced from CMPUT261 Assignment 2 package
Modified for purpose of assignment. Personal contributions found beneath #TODO instances
...
2. Careful when you use AI tools. Do not copy and paste code directly from AI tools. 
   Submitting pure AI generated code could possibly be marked 0.
...
def main():
    ...
    print(f"P(C=0 | E=0, F=1) = {solution[0]}")
